          ...
          {user && user?.email ? (
            <>
              ...
              <div
                className={`${
                  avatar
                    ? "rounded-md flex flex-col gap-2 py-6 bg-gray-100 dark:bg-slate-800 w-80 px-4 absolute right-20 top-[88px]"
                    : "hidden"
                }`}
              >
                <div>
                  <div
                    className={`avatar ${
                      avatar ? "flex  justify-center items-center" : "hidden"
                    } pb-2`}
                  >
                ...
                <ul className=" py-3 space-y-3">
                  {user && user?.email === "admin5@gmail.com" && (
                    <>
          ...
          <div className=" flex flex-col  gap-5 items-center">
            {user?.email ? (
              ...
              <Link onClick={handleClick} to="/signIn">
                <button className=" px-6 py-2.5 dark:text-gray-400 cursor-pointer  rounded-md ">
                  Login
                </button>
              </Link>
            )}
